...
Покажи: путь создаваемого файла, содержимое записи, что будет удалено/очищено. Если задача из implementation-plan — укажи: «Будет добавлена [step_id]» или «Следующая задача не добавлена: нет шагов с выполненными зависимостями». Дождись явного подтверждения пользователя.
